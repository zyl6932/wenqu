    ...
    <div style={{ padding: '4px 16px 8px' }}>
      <div style={{ position: 'relative' }}>
        <input
          ...
          style={{ width: '100%', padding: '7px 24px 7px 10px', border: '1px solid var(--border)', borderRadius: 3, fontSize: 12, background: 'var(--bg)', color: 'var(--ink)', outline: 'none', fontFamily: 'var(--serif)' }}
        />
        {value && (
